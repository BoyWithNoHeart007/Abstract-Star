...
class icici extends Bank{
    ...
    void Rates_of_Interest(){
        ...
        System.out.println("ICICI Bank Interest rate = "+a);
...
class bob extends Bank{
    ...
    void Rates_of_Interest(){
        ...
        Double a = sc.nextDouble();
        System.out.println("BOB Bank Interest rate = "+a);
    } 
}
class sbi extends Bank{
    ...
    void Rates_of_Interest(){
        ...
        Double a = sc.nextDouble();
        System.out.println("SBI Bank Interest rate = "+a);
    } 
}
class kotak extends Bank{
    ...
    void Rates_of_Interest(){
        ...
        Double a = sc.nextDouble();
        System.out.println("Kotak Bank Interest rate = "+a);
    } 
}